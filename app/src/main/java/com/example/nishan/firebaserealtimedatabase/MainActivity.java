...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinnerGeneres = (Spinner)findViewById(R.id.spinnerGeners);
    ...
    private void showUpdateDialog(final String artistId, String artistname){
        ...
        final Spinner spinnerGenres = (Spinner)dialogView.findViewById(R.id.spinnerGeners);
    ...
    private void deleteArtist(String artistId){
        ...
        DatabaseReference databaseReferenceTracks = FirebaseDatabase.getInstance().getReference("track").child(artistId);
